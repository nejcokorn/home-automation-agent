...
```bash
curl -fL -o home-automation-agent_1.2.0_arm64.deb \
  https://github.com/nejcokorn/home-automation-agent/releases/download/v1.2.0/home-automation-agent_1.2.0_arm64.deb
...
- Upload `home-automation-agent_1.2.0_arm64.deb`.
- Optionally upload `home-automation-agent-dbgsym_1.2.0_arm64.deb`.
